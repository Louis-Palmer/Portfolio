...
const hero: {
	...
	links: [
		...
		{ label: 'LinkedIn', href: 'https://www.linkedin.com/in/louispalmer-dev/', icon: 'i-carbon-logo-linkedin' },
		// { label: 'Twitter', href: 'https://twitter.com', icon: 'i-carbon-logo-twitter' },
		{ label: 'Email', href: 'mailto:louispalmer01@outlook.com', icon: 'i-carbon-at' }
	]
};
